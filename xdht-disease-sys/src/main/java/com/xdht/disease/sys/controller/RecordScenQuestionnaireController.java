...
public class RecordScenQuestionnaireController {
    ...
    public  ResponseEntity<Result<List<RecordScenQuestionnaire>>> recordList(@CurrentUser User user, @RequestBody RecordScenQuestionnaireRequest recordScenQuestionnaireRequest) {
    ...
    public ResponseEntity<Result<PageResult<RecordScenQuestionnaire>>> recordPage(@CurrentUser User user, @RequestBody RecordScenQuestionnaireRequest recordScenQuestionnaireRequest,@RequestParam Integer pageNum,@RequestParam Integer pageSize) {
    ...
    public ResponseEntity<Result<RecordScenQuestionnaire>> addRecordScenQuestionnaire(@CurrentUser User user, @RequestBody RecordScenQuestionnaire recordScenQuestionnaire) {
    ...
    public ResponseEntity<Result<RecordScenQuestionnaire>> deleteRecordScenQuestionnaire(@CurrentUser User user, @RequestParam Long id) {
    ...
    public ResponseEntity<Result<RecordScenQuestionnaire>> updateRecordScenQuestionnaire(@CurrentUser User user, @RequestBody RecordScenQuestionnaire recordScenQuestionnaire) {
