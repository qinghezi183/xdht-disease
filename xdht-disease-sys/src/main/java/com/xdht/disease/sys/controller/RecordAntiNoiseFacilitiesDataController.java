...
public class RecordAntiNoiseFacilitiesDataController {
    ...
    public  ResponseEntity<Result<List<RecordAntiNoiseFacilitiesData>>> recordList(@CurrentUser User user, @RequestBody RecordAntiNoiseFacilitiesDataRequest recordAntiNoiseFacilitiesDataRequest) {
    ...
    public ResponseEntity<Result<PageResult<RecordAntiNoiseFacilitiesData>>> recordPage(@CurrentUser User user, @RequestBody RecordAntiNoiseFacilitiesDataRequest recordAntiNoiseFacilitiesDataRequest,@RequestParam Integer pageNum,@RequestParam Integer pageSize) {
    ...
    public ResponseEntity<Result<RecordAntiNoiseFacilitiesData>> add(@CurrentUser User user, @RequestBody RecordAntiNoiseFacilitiesData recordControlEffectData) {
    ...
    public ResponseEntity<Result<RecordAntiNoiseFacilitiesData>> delete(@CurrentUser User user, @RequestParam Long id) {
        return new ResponseEntity<>(Result.ok(recordAntiNoiseFacilitiesDataService.delete(id)), HttpStatus.OK);
    }

    @RequestMapping(value = "/update", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    @ApiOperation(value = "修改")
    public ResponseEntity<Result<RecordAntiNoiseFacilitiesData>> update(@CurrentUser User user, @RequestBody RecordAntiNoiseFacilitiesData recordAntiNoiseFacilitiesData) {
